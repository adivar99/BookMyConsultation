package com.bmc.userservice.documents;
...
public class S3Repository {
    ...
    private String BUCKET_NAME = "bmc-bucket-user";// This needs to be a unique bucket name across all the regions.
